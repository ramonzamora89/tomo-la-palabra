...
- **Ventana de videos**: `/videos` muestra los 24 más recientes (`limit` por defecto en `lib/youtube.ts`). El canal ya tiene 46. Subir el límite a 50 es cambiar un número; más allá de 50 hay que paginar con `pageToken`.
